...
git. `Peter Lundgren`_ wrote an excellent `blob post`_ to this effect. 
`Steve Losh`_ also wrote an excellent `metaphor for git's UX`_, comparing 
...
.. _blob post:              http://www.peterlundgren.com/blog/on-gits-shortcomings/
.. _Steve Losh:             http://stevelosh.com/
.. _metaphor for git's UX:  http://stevelosh.com/blog/2013/04/git-koans/
